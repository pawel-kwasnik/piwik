 ...
 *
 */
namespace Piwik\Plugins\VisitsOddEven\Reports;
 ...
 */
class GetVisitsOddEvenReport extends Base
{
    protected function init()
    {
        parent::init();

        $this->name          = Piwik::translate('VisitsOddEven_VisitsOddEvenReport');
        $this->dimension     = null;
        ...
        // $this->menuTitle    = 'VisitsOddEven_VisitsOddEvenReport';
        ...
        // $this->widgetTitle  = 'VisitsOddEven_VisitsOddEvenReport';
    }
...
//        $view->config->columns_to_display = array_merge(array('label'), $this->metrics);
    ...
    {
        $view = new View('@VisitsOddEven/getVisitsOddEvenReport');
        $view->myData = array();
