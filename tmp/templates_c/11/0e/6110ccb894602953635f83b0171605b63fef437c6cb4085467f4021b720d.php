        ...
        <table id='anonymousUserSettingsTable' class=\"adminTable\" style='width:850px;'>
            <tr>
                ...
                if ((!twig_test_empty((isset($context["anonymousSites"]) ? $context["anonymousSites"] : $this->getContext($context, "anonymousSites"))))) {
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["info"]) {
                        // line 151
                        echo "                                    <option value=\"";
                        echo twig_escape_filter($this->env, $this->getAttribute($context["info"], "idsite", array()), "html", null, true);
                        echo "\" ";
                        if (((isset($context["anonymousDefaultReport"]) ? $context["anonymousDefaultReport"] : $this->getContext($context, "anonymousDefaultReport")) == $this->getAttribute($context["info"], "idsite", array()))) {
                            echo " selected=\"selected\"";
                        }
                        echo ">";
                        echo $this->getAttribute($context["info"], "name", array());
                        echo "</option>
                                ";
                    }
                    $_parent = $context['_parent'];
            ...
            <tr>
                ...
                foreach ($context['_seq'] as $context["value"] => $context["description"]) {
                    ...
                    echo twig_escape_filter($this->env, $this->getAttribute($context["loop"], "index", array()), "html", null, true);
                    echo "\" type=\"radio\" ";
                    if (((isset($context["anonymousDefaultDate"]) ? $context["anonymousDefaultDate"] : $this->getContext($context, "anonymousDefaultDate")) == $context["value"])) {
                        echo "checked=\"checked\" ";
                    }
                    echo "value=\"";
                    echo twig_escape_filter($this->env, $context["value"], "html", null, true);
